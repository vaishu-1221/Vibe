...
const SenderMessage = ({ message }) => {
    ...
    return (
        ...
        to-[#ff0095] rounded-t-2xl rounded-bl-2xl rounded-br-0 px-[10px]
        py-[10px] relative ml-auto right-0 flex flex-col gap-[10px]'>
            ...
            absolute-hidden absolute right-[-25px] bottom-[-40px]'>
